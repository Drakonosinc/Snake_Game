...
class GameMode(BaseMenu):
    ...
    def setup_buttons(self):
        ...
        self.buttons['player'] = factory.create_TextButton({"text": "Player","position": (50,self.HEIGHT/2-50),"command1":lambda:self.type_game(False,True),"command2":lambda:self.update_mode_buttons()})
        self.buttons['ai'] = factory.create_TextButton({"text": "AI","position": (50,self.HEIGHT/2),"command1":lambda:self.type_game(False,False,True),"command2":lambda:self.update_mode_buttons()})
