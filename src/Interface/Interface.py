...
class interface(load_elements):
    ...
    def buttons_keys(self):
        ...
        self.up2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key2"],"position": (self.WIDTH/2,self.HEIGHT/2-100),"command1":lambda:self.change_keys("key_up2","Name_key2",self.up2_button)})
        self.down2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key4"],"position": (self.WIDTH/2,self.HEIGHT/2),"command1":lambda:self.change_keys("key_down2","Name_key4",self.down2_button)})
        self.left2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key6"],"position": (self.WIDTH/2,self.HEIGHT/2-50),"command1":lambda:self.change_keys("key_left2","Name_key6",self.left2_button)})
        self.right2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key8"],"position": (self.WIDTH/2,self.HEIGHT/2-50),"command1":lambda:self.change_keys("key_right2","Name_key8",self.right2_button)})
