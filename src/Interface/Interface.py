...
class interface(load_elements):
    ...
    def buttons_visual(self):
        ...
        self.decrease_body_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": "<","position": (self.WIDTH/2-100,self.HEIGHT/2-50),"command1":lambda:self.change_items("value_snake_body","snake_body",-1)})
        ...
        self.decrease_food_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": "<","position": (self.WIDTH/2-100,self.HEIGHT/2),"command1":lambda:self.change_items("value_foods","food",-1)})
