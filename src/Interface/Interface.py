...
class interface(load_elements):
    ...
    def menu_AI(self):
        ...
        self.screen.blit(self.font2_5.render(f"Generation Size\n{self.config.config_AI['generation_value']:^36}", True, "White"),(50,self.HEIGHT/2-100))
        self.screen.blit(self.font2_5.render(f"Population Size\n{self.config.config_AI['population_value']:^36}", True, "White"),(50,self.HEIGHT/2-25))
        self.screen.blit(self.font2_5.render(f"Attempts By AI\n{self.config.config_AI['try_for_ai']:^{39 if self.config.config_AI['try_for_ai']<10 else 36}}", True, "White"),(50,self.HEIGHT/2+50))
        self.screen.blit(self.font2_5.render(f"Save model", True, "White"),(50,self.HEIGHT/2+125))
