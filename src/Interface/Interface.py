...
class interface(load_elements):
    ...
    def buttons_config_AI(self):
        ...
        self.scroll=self.button_factory_f2_5.create_ScrollBar({"position": (self.WIDTH-30, 50, 20, self.HEIGHT-100),"thumb_height": 20,"thumb_ratio": 0.2,"elements": [*self.buttons_in_config_AI]})
