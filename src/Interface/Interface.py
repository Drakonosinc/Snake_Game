...
class interface(load_elements):
    ...
    def items_visuals(self):
        self.screen.blit(self.head_snake,(self.player.rect_head.x,self.player.rect_head.y+50))
        self.screen.blit(self.body_snake,(self.WIDTH/2-50,self.HEIGHT/2))
    def buttons_visual(self):
        ...
        self.decrease_player_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": "<","position": (self.WIDTH/2-95,self.HEIGHT/2),"command1":lambda:self.change_items("value_snake_head","snake_head",-1)})
        self.increase_player_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": ">","position": (self.WIDTH/2+75,self.HEIGHT/2),"command1":lambda:self.change_items("value_snake_head","snake_head",1)})
        self.decrease_body_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": "<","position": (self.WIDTH/2-95,self.HEIGHT/2),"command1":lambda:self.change_items("value_snake_body","snake_body",-1)})
    ...
    def buttons_keys(self):
        ...
        self.down2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key3"],"position": (50,self.HEIGHT/2),"command1":lambda:self.change_keys("key_down2","Name_key4",self.down2_button)})
        self.left1_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key3"],"position": (50,self.HEIGHT/2),"command1":lambda:self.change_keys("key_left","Name_key5",self.left1_button)})
        self.left2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key3"],"position": (50,self.HEIGHT/2),"command1":lambda:self.change_keys("key_left2","Name_key6",self.left2_button)})
        self.right1_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key3"],"position": (50,self.HEIGHT/2),"command1":lambda:self.change_keys("key_right","Name_key7",self.right1_button)})
        self.right2_button = self.button_factory_f2_5.create_TextButton({"text": self.config.config_keys["Name_key3"],"position": (50,self.HEIGHT/2),"command1":lambda:self.change_keys("key_right2","Name_key8",self.right2_button)})
