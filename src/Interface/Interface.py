...
class interface(load_elements):
    ...
    def menu_AI(self):
        ...
        self.screen.blit(self.font2_5.render(f"Generation Size\n{self.config.config_AI['generation_value']:^36}", True, "White"),(50,self.HEIGHT/2-120))
        self.screen.blit(self.font2_5.render(f"Population Size\n{self.config.config_AI['population_value']:^36}", True, "White"),(50,self.HEIGHT/2-45))
        self.screen.blit(self.font2_5.render(f"Attempts By AI\n{self.config.config_AI['try_for_ai']:^{39 if self.config.config_AI['try_for_ai']<10 else 36}}", True, "White"),(50,self.HEIGHT/2+30))
        self.screen.blit(self.font2_5.render(f"Save model", True, "White"),(50,self.HEIGHT/2+105))
        self.execute_buttons(self.increase_generation,self.decrease_generation,self.increase_population,self.decrease_population,self.increase_try_for_ai,self.decrease_try_for_ai,self.save_model,self.continue_button,self.B_mode_game_button)
    ...
    def buttons_config_AI(self):
        self.increase_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.WIDTH-140,self.HEIGHT/2-100),"command1":lambda:self.increase_decrease_variable(self.config._AI,'generation_value')})
        self.decrease_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (50,self.HEIGHT/2-120),"command1":lambda:self.increase_decrease_variable(self.config.config_AI,'generation_value',True,-1)})
        self.increase_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.WIDTH-140,self.HEIGHT/2-70),"command1":lambda:self.increase_decrease_variable(self.config.config_AI,'population_value')})
        self.decrease_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (50,self.HEIGHT/2-70),"command1":lambda:self.increase_decrease_variable(self.config.config_AI,'population_value',True,-1)})
        self.increase_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.WIDTH-140,self.HEIGHT/2-20),"command1":lambda:self.increase_decrease_variable(self.config.config_AI,'try_for_ai')})
        self.decrease_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (50,self.HEIGHT/2-20),"command1":lambda:self.increase_decrease_variable(self.config.config_AI,'try_for_ai',True,-1)})
        self.save_model = self.button_factory_f2_5.create_TextButton({"text": "OFF","color": self.SKYBLUE,"position": (self.WIDTH-105,self.HEIGHT/2-100),"command1":lambda:self.on_off(self.config.config_AI,"model_save"),"command2":self.config.save_config})
