...
class interface(load_elements):
    ...
    def buttons_visual(self):
        ...
        self.decrease_player_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": "<","position": (self.player.rect_head.x-40,self.player.rect_head.y+70),"command1":lambda:self.change_items("value_snake_head","snake_head",-1)})
        self.increase_player_button = self.button_factory_f2_5.create_TextButton({"font": self.font3_5,"text": ">","position": (self.player.rect_head.x+60,self.player.rect_head.y+70),"command1":lambda:self.change_items("value_snake_head","snake_head",1)})
